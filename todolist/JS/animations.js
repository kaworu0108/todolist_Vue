init = function(){
      ...
      jarallax.addAnimation('.planet3',[{progress: "-10%", top:"90%"}, {progress: "100%", top: "60%"}]);
      jarallax.addAnimation('.planet2',[{progress: "10%", top:"70%"}, {progress: "100%", top: "40%"}]);
      jarallax.addAnimation('.planet1',[{progress: "10%", top:"90%"}, {progress: "100%", top: "-5%"}]);
